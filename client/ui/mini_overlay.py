...
from PyQt5.QtWidgets import QApplication, QBoxLayout, QFrame, QGridLayout, QHBoxLayout, QLabel, QPushButton, QVBoxLayout, QWidget
...
class MiniOverlay(QWidget):
    ...
    def show_realtime_for_target(self, reader_name="", window_title="", window_handle=None):
        ...
        if reader_name == "word":
            ...
            label = "\uba54\ubaa8\uc7a5 \uc2e4\uc2dc\uac04 \uad50\uc815"
        elif reader_name in {"browser", "browser_extension"}:
            label = "\ube0c\ub77c\uc6b0\uc800 \uc2e4\uc2dc\uac04 \uad50\uc815"
        self.title_label.setText(label)
